...
class WizardNine extends Component {
  render() {
    const { addressOne, addressTwo, addressThree } = this.props;
    return (
      <div className="parent-div">
        <div className="vert-align">
          ...
          <input
            ...
            onChange={e => addressOne(e.target.value)}
          />
          <input
            type="text"
            placeholder="Line Two"
            onChange={e => addressTwo(e.target.value)}
          />
          <input
            type="text"
            placeholder="Line Three"
            onChange={e => addressThree(e.target.value)}
          />
          <Link to="/wTen">
